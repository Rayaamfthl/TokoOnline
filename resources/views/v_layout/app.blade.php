...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('backend/matrix-admin-master/assets/extra-libs/multicheck/multicheck.css') }}">
    <link href="{{ asset('backend/matrix-admin-master/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }}"
        rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                                href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ asset('backend/matrix-admin-master/assets/images/users/1.jpg') }}"
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Web Programming 2, Studi kasus Toko Online <a href="https://instagram.com/rayaamfthl_">Miftahul
                    Raya</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
    ...
    <!-- this page js -->
    <script src="{{ asset('backend/matrix-admin-master/assets/extra-libs/multicheck/datatable-checkbox-init.js') }}">
    </script>
